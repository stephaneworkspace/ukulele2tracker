...
class UkuTabs extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint = Paint()
      ...
      ..strokeCap = StrokeCap.round;
    // Circle
    canvas.drawCircle(Offset(pXDiv2, (pYBeginLigne0 + (espacementY * 5) + espacementY / 2)), circleHelperRadius, paint);
    canvas.drawCircle(Offset(pXDiv2, (pYBeginLigne0 + (espacementY * 7) + espacementY / 2)), circleHelperRadius, paint);
    canvas.drawCircle(Offset(pXDiv2, (pYBeginLigne0 + (espacementY * 10) + espacementY / 2)), circleHelperRadius, paint);
    canvas.drawCircle(Offset(pXDiv2, (pYBeginLigne0 + (espacementY * 12) + espacementY / 2)), circleHelperRadius, paint);
  }
